...
export async function saveFile(blob, baseName, options = {}) {
  ...
  // Every video must pass through the MP4 export pipeline. Do not silently
  // download the raw MediaRecorder blob: that can contain mismatched track
  // timing and may be rejected by Instagram.
  ...
  try {
    ...
    if ("download" in anchor) {
      ...
      return {
        method: "download",
        filename,
        note: "Exported and verified as an Instagram-ready MP4.",
      };
    }
