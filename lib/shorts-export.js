...
function chooseMime(withAudio) {
  ...
  const mp4 = withAudio ? ["video/mp4;codecs=avc1.42E01E,mp4a.40.2","video/mp4"] : ["video/mp4"];
  const webm = withAudio ? ["video/webm;codecs=vp9,opus","video/webm;codecs=vp8,opus","video/webm"] : ["video/webm;codecs=vp9","video/webm"];
