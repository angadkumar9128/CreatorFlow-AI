...
function pickMimeType(withAudio) {
  ...
  // Android Chrome's canvas->MP4 recorder can emit an MP4 whose video track
  // ends early while the audio track keeps running. Prefer WebM there and let
  // the final FFmpeg export create the Instagram MP4.
